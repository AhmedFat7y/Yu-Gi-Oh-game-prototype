...
class YuGiOh_spider(CrawlSpider):
  ...
  start_urls = ['http://www.db.yugioh-card.com/yugiohdb/card_search.action?ope=1&sess=1&pid=13311002&rp=99999']
  rules = []
  #rules += [Rule(LinkExtractor(tags='input', attrs='value', restrict_xpaths='//*[@class="pack pack_en"]', unique=True), 'parse_deck', follow=True)]
